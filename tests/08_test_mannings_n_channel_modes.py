...
hydroflow/core/routing/surface.py).
...
from hydroflow.core.routing.surface import resolve_mannings_n
from hydroflow.utils.terrain_rules import apply_elevation_rule, mannings_n_from_dem
...
class _Cfg:
    """Minimal stand-in for hydroflow.Config exposing only what

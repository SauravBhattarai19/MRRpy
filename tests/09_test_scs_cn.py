...
(ScsCnMode in hydroflow/core/runoff/engine.py).
...
from hydroflow.core.runoff import RunoffEngine, RunoffMode, register, RUNOFF_MODES
from hydroflow.core.runoff.engine import _apply_amc
...
class _Cfg:
    """Minimal stand-in for hydroflow.Config exposing only what ScsCnMode reads."""

...
==========================
Pytest suite that exercises the scientific core of ``hydroflow`` without any
...
from hydroflow.core.runoff import RunoffEngine, MECHANISM_REGISTRY
...
def test_raster_to_grid_aligns_foreign_crs_and_nodata(chain_rasters, tmp_path):
    ...
    from hydroflow.core.io_utils import raster_to_grid

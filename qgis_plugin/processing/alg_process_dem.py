...
class ProcessDemAlgorithm(QgsProcessingAlgorithm):
    """QGIS Processing wrapper for pymrr.core.process_dem.main()."""
    ...
    # Literal pymrr.config.OpmConfig.DELINEATION_ENGINE values, in dropdown
    ...
    def processAlgorithm(self, parameters, context, feedback):  # noqa: N802
        ...
        from pymrr.core import dem_processing as pd_mod

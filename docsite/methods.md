...
MRRpy separates **runoff generation** (turning rainfall into effective
...
`MRRpy list-options` or `Config.describe_options()`.
...
!!! tip "Add your own runoff method"
    ...
    from your own package without editing MRRpy. See the

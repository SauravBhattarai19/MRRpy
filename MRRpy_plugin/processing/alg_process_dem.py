...
class ProcessDemAlgorithm(QgsProcessingAlgorithm):
    """QGIS Processing wrapper for MRRpy.core.process_dem.main()."""
    ...
    # Literal MRRpy.config.Config.DELINEATION_ENGINE values, in dropdown
    # order — index 0 (pyflwdir) is the default, matching the interactive
    # Tab-1 dialog (see MRRpy_plugin/ui/tab_dem.py).  pyflwdir (priority-flood
    ...
    def processAlgorithm(self, parameters, context, feedback):  # noqa: N802
        ...
        from MRRpy.core import dem_processing as pd_mod

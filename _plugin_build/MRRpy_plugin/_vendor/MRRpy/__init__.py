# -*- coding: utf-8 -*-
"""
MRRpy (Multi-Mechanism Runoff and Routing) — a distributed, physics-based
...
cli    : the ``MRRpy`` command-line interface (config-file driven runs).
...
stage fetch one automatically (requires ``pip install MRRpy[gee]`` +
authentication).
"""

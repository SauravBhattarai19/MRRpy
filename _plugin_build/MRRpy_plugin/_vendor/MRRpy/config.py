...
class Config:
    ...
    # which correctly resolves flow across large flat reservoirs/lakes where
    # pysheds' fill+resolve_flats can collapse flow accumulation (see
    # MRRpy/core/dem_processing.py).  'pysheds' is the original engine, kept

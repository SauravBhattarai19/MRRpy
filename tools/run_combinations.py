...
# capacity (see MRRpy/core/runoff/vsa.py: self._sandbox_infilt_on).  This is
...
# rain-gauge zone (MRRpy/core/runoff/soil.py: per_zone_sd_from_raster).
...
def all_configs():
    ...
    for chan, scheme, mset, infilt, reducer in itertools.product(
        ...
        overrides = {
            ...
            # controls only the sandbox's own recharge cap (MRRpy/core/runoff/vsa.py).
